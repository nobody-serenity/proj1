...
static const duration_def duration_data[] =
{
    ...
    { DUR_COLD_VULN,
      ...
      "You are more vulnerable to cold.", D_DISPELLABLE | D_NEGATIVE,
      {{ "You feel less vulnerable to cold." }}},
    { DUR_CORR_VULN,
      RED, "rCorr-",
      "corrosion vulnerable", "corrosion vulnerability",
      "You are more vulnerable to corrosion.", D_DISPELLABLE | D_NEGATIVE,
      {{ "You feel less vulnerable to corrosion." }}},
    { DUR_BARBS,
      RED, "Barbs",
